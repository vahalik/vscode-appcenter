...
function registerAppCenterCommands(context: vscode.ExtensionContext): void {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand(CommandNames.Settings.LoginToAnotherAccount, () =>
            _extensionManager.RunCommand(() => settingsCommandHandler.LoginToAnotherAccount()),
        ),
    );
    context.subscriptions.push(
        vscode.commands.registerCommand(CommandNames.Settings.SwitchAccount, () =>
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand(CommandNames.Settings.SwitchAccountVsts, () =>
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand(CommandNames.Settings.ShowStatusBar, () =>
            _extensionManager.RunCommand(() => settingsCommandHandler.ShowStatusBar()),
        ),
    );
    context.subscriptions.push(
        vscode.commands.registerCommand(CommandNames.Settings.HideStatusBar, () =>
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand(CommandNames.CodePush.SetCurrentDeployment, () =>
            _extensionManager.RunCommand(() => codepushCommandHandler.SetCurrentDeployment()),
        ),
    );
    context.subscriptions.push(
        vscode.commands.registerCommand(CommandNames.CodePush.ReleaseReact, () =>
            _extensionManager.RunCommand(() => codepushCommandHandler.ReleaseReact()),
        ),
    );
    context.subscriptions.push(
        vscode.commands.registerCommand(CommandNames.CodePush.SwitchMandatoryPropForRelease, () =>
            _extensionManager.RunCommand(() => codepushCommandHandler.SwitchMandatoryPropForRelease()),
        ),
    );
    context.subscriptions.push(
        vscode.commands.registerCommand(CommandNames.CodePush.SetTargetBinaryVersion, () =>
            _extensionManager.RunCommand(() => codepushCommandHandler.SetTargetBinaryVersion()),
        ),
    );
    context.subscriptions.push(
        vscode.commands.registerCommand(CommandNames.CodePush.LinkCodePush, () =>

export class LogStrings {
    ...
    public static CodePushInstallMessage = "Make sure you ran \"npm install\" and that you are inside a React Native CodePush project.";
    public static AppCenterInstallMessage = "Make sure you ran \"npm install\" and that you are inside a React Native App Center project.";
    public static ReactNativeInstallMessage = "Make sure you ran \"npm install\" and that you are inside a React Native project.";
    ...
    public static FailedToGetProfileFile = "Profile not found. Login to the App Center via the Visual Studio Code Extension to create the profile.";

...
export class Messages {
    ...
    public static StatusBarAlreadyShownMessage = "The status bar is already shown. Look, it's in the bottom left corner of the window, with your name/app name on it!";
    ...
    public static PleaseLoginViaBrowserMessage = "You are about to be redirected to page containing a new App Center access token. Please copy and paste it here after you press Ok.";
    public static CrashesSimulatedMessage = "The crash has been successfully generated and sent to App Center!";
    public static PodsNotInstalledMessage = "It looks like you haven't installed CocoaPods. You need it to run the application on iOS. After the installation, run 'cd ios && pod update'.";
    public static AppCenterBeforeLinkMessage = "We will run 'react-native link' command for you. When you press OK, you will see a message with your app secrets.";
...
The current app is '${currentAppName}'.`;
    ...
    // #region Warnings
    public static NotReactProjectWarning = "This command can only be executed from a React Native project. Check out the Output window for more details.";
    ...
    public static InvalidAppVersionParamWarning = "Sorry, the provided app version isn't valid. It should be in a valid semver vesion format.";
    public static NotCodePushProjectWarning = "This command can only be executed from a React Native project with CodePush installed. Check out the Output window for more details.";
    public static GitIsNotInstalledWarning = "It looks like you don't have a local git client installed.";
    public static ProjectNameIsNotValidWarning = "Sorry, the project name your entered is invalid. Make sure its starts with a letter and has no whitespaces in it.";
    public static VstsCredsNotValidWarning = "VSTS credentials are not valid.";
    public static DirectoryIsNotEmptyForNewProjectWarning = "Sorry, you can only start a new project inside an empty folder.";
    ...
    public static FailedToConnectRepoToBuildService = "Failed to connect the repository to the build service. Check out the Output window for more details.";
    public static FailedToConfigureBranchAndStartNewBuild = "Failed to configure the branch for build. Check out the Output window for more details.";
    public static FailedToCreateDistributionGroup = "Failed to create distribution groups. Check out the Output window for more details.";
    ...
    public static FailedToGenerateCrashes = "An error occurred while generating crashes. Please check the output window for more details.";

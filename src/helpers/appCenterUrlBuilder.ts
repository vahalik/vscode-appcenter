...
export class AppCenterUrlBuilder {
    ...
    public static GetAppCenterLinkByBeacon(
        ownerName: string,
        appName: string,
    ...
    public static GetAppCenterDistributeTabLinkByTabName(
        ownerName: string,
        appName: string,
    ...
    public static GetPortalBuildConfigureLink(
        appOwner: string,
        appName: string,
        branchName: string,
        isOrg: boolean,
    ...
    public static GetPortalBuildLink(
        appOwner: string,
        appName: string,
        branchName: string,
        buildId: string,
